...
# st.markdown("""
# This page provides a high-level business summary of the applicant portfolio,
# loan amount distribution, customer profile, and overall default risk position.
# """)
...
# st.subheader("📍 Applicant Portfolio Snapshot")
...
# most_common_income = get_mode_value(df, "NAME_INCOME_TYPE")
# most_common_education = get_mode_value(df, "NAME_EDUCATION_TYPE")
# most_common_housing = get_mode_value(df, "NAME_HOUSING_TYPE")
# most_common_contract = get_mode_value(df, "NAME_CONTRACT_TYPE")
...
# with col1:
#     st.plotly_chart(pie_chart(df,"CODE_GENDER","Applications by Gender"),use_container_width=True)
...
#             "NAME_EDUCATION_TYPE",
#             None,
#             "Applications by Education Type"
#         ),
#         use_container_width=True
#     )
...
# def highest_risk_group(dataframe, group_col):
#     if group_col in dataframe.columns:
#         risk_data = (
#             dataframe
...
#             return risk_data.idxmax()

#     return "Not Available"


# highest_risk_income = highest_risk_group(df, "NAME_INCOME_TYPE")
# highest_risk_education = highest_risk_group(df, "NAME_EDUCATION_TYPE")
# highest_risk_housing = highest_risk_group(df, "NAME_HOUSING_TYPE")
# highest_risk_contract = highest_risk_group(df, "NAME_CONTRACT_TYPE")
...
# - Most common income type: **{most_common_income}**
# - Most common education type: **{most_common_education}**
# - Most common housing type: **{most_common_housing}**
# - Most common contract type: **{most_common_contract}**
# """
#     )
...
# - Highest risk education type: **{highest_risk_education}**
# - Highest risk housing type: **{highest_risk_housing}**
...
most_common_income_type = get_mode_value(
    df,
    "NAME_INCOME_TYPE"
)

most_common_education_level = get_mode_value(
    df,
    "NAME_EDUCATION_TYPE"
)

highest_risk_segment, highest_risk_segment_rate = get_highest_risk_segment(
    df,
    "NAME_INCOME_TYPE"
)
