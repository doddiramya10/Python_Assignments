...
# ✅ Credit amount has a strong relationship with repayment risk.
# """
# )
...
with col2:
    st.warning(
        f"""
⚠️ Highest Risk Credit Group: {highest_risk_credit_group}


⚠️ Higher credit amounts may be associated with higher repayment risk.
"""
    )